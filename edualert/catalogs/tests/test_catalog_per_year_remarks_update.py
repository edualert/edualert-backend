...
@ddt
class CatalogPerYearRemarksUpdateTestCase(CommonAPITestCase):
    @classmethod
    ...
    def test_catalogs_per_year_remarks_update_unauthenticated(self):
    ...
    def test_catalogs_per_year_remarks_update_wrong_user_type(self, user_role):
    ...
    def test_catalogs_per_year_remarks_update_catalog_does_not_exist(self):
    ...
    def test_catalogs_per_year_remarks_update_validations(self):
        self.client.login(username=self.teacher.username, password='passwd')
