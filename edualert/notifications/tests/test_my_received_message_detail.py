...
@ddt
class MyReceivedMessageDetailTestCase(CommonAPITestCase):
    @classmethod
    ...
    def build_url(message_id):
        return reverse('notifications:my-received-message-detail', kwargs={'id': message_id})

    def test_my_received_message_detail_unauthenticated(self):
        response = self.client.get(self.build_url(self.target_user_through.id))
    ...
    def test_my_received_message_detail_wrong_user_type(self, user_role):
    ...
    def test_my_received_notification_detail_non_existent(self):
    ...
    @unpack
    def test_my_received_notification_detail_success(self, target_profile_param, sender_profile_param, receiver_type, target_users_role,
        ...
        target_through = TargetUserThroughFactory(notification=notification, is_read=True, user_profile=target_profile)
